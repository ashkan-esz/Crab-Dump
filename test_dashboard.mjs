...
assert.match(routingHtml, /ensureSession/);
assert.match(routingHtml, /api\/auth\/login/);
assert.match(routingHtml, /r\.status===401/);
assert.match(routingHtml, /sessionEstablished=false/);
assert.match(routingHtml, /await ensureSession\(\)/);
assert.match(routingHtml, /credentials:'same-origin'/);
...
assert.match(databasesHtml, /sessionEstablished=false/);
assert.match(databasesHtml, /await ensureSession\(\)/);
assert.match(databasesHtml, /credentials:'same-origin'/);
